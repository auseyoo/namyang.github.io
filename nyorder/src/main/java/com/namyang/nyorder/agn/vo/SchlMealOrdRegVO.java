...
@Getter
@Setter
public class SchlMealOrdRegVO extends CommVO{
	private int vendSeq;		//거래처 시퀀스
	private String vendNm;		//거래처 이름
	...
	private String eveReqBoxQty;		// 직전 박스 주문량
	private String eveReqIddyQty;		// 직전 낱봉 주문량
