...
var myGridID3;
	...
	var gridPros = {
			...
			fixedRowCount : 1,
			excludeFixedRowsOnSorting : true
	};
	...
	function searchList(){
		$.ajax({
			url : "/sel/selectEmplList.do", 
			type : 'POST', 
			data : $("#frm").serialize(),
			success : function(data) {
				AUIGrid.setGridData(myGridID, data);
				var item = {emplNm : "전체", emplSeq : ""};
	...
	function searchSaleList(){
		...
		var rows = AUIGrid.getSelectedItems(myGridID);
		$("#emplSeq").val(rows[0].item.emplSeq);
		$.ajax({
			url : "/sel/selectEmplSaleSttsList.do", 
			type : 'POST', 
			data : $("#frm").serialize(),
			success : function(data) {
	...
	<form id="frm">
		...
		<div class="inquiryBox">
			<dl>
				...
				<dd>
					<div class="formWrap">
						<input type="hidden" name="emplSeq" id="emplSeq" />
