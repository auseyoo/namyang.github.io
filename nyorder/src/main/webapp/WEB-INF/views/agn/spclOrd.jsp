<!--
	@File Name: schlMealOrd
	@File 설명 : 학교급식 주문 조회
	@UI ID : 	UI-PORD-0501.html
	@작성일 : 2022.02.14
	@작성자 : 윤이준
 -->
					...
					<dd>
						<div class="formWrap">
							...
							<div class="checkGroup">
								<input type="radio" name="searchType" value="dlv" id="type1"  class="type01" checked><label for="type1"><span>출고요청일</span></label>
