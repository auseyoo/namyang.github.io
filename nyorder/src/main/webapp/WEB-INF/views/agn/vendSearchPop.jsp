...
var columnLayout = [
	{dataField:"vendCd",		headerText:"주간판매점코드",width:"18%",style:"auiLink"},
	{dataField:"vendNm",		headerText:"주간판매점명",	style:"auiLeft"},
	{dataField:"vendPrst",		headerText:"대표자",		width:"17%",},
	{dataField:"prstMobNo",		headerText:"휴대폰번호",	width:"17%",},
	{dataField:"vendStusSec",	headerText:"상태",		width:"17%",}
];

function selectVendList() {
	$.ajax({
		url : "/agn/selectVendList.do",
		type : 'POST',
...
<!-- 본사주간판매점 선택 -->
<div class="popWrap mideum modal_wrap h520" data-popup="modalAgencyViews03">
	<header>
		<h3>본사주간판매점 선택</h3>
	</header>  
