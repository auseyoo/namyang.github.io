<!-- 
	@File Name: tmprtOrdrReg
	@File 설명 : 주문 등록(상온)
	@UI ID : 	UI-PORD-0103.html
	@작성일 : 2022.03.25
	@작성자 : 윤이준
 -->
...
<!-- 출하구분 -->
<code:makeSelect commGrpCd="SD0019" var="shipmntCdList" name="shipmntCd" classNm="sel" all="false" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#shipmntCd option").each(function( idx , item ){
			if( !( item.value == '10' || item.value == '20' || item.value == '40' ) ) $(this).remove();
		});
	...
	function selectOrderCnt (){
		var item = { "ordDt" : getToday() , "ordType" : $("#ordType").val() , "vendSeq" : 0 };
...
<div class="content">
	...
	<form id="frm">
		...
		<input type="hidden" name="ordType" id="ordType" value="TMPRT">
