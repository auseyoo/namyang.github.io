...
function createAUIGrid(columnLayout) {
	...
	var columnLayout = [ 
		{	dataField : "menuSeq",		headerText : "메뉴일련번호",	width:100,	editable:false	},
		{	dataField : "lvl1",			headerText : "LEVEL1",		width:150,	style : "left", editable:false	},
		{	dataField : "lvl2",			headerText : "LEVEL2",		width:150,	style : "left", editable:false	},
		{	dataField : "lvl3",			headerText : "LEVEL3",		width:150,	style : "left", editable:false	},
	...
	<form id="frm" method="post">
		<div class="inquiryBox">
			...
			<div class="btnGroup right">
				...
				<button type="button" id="addBtn"	class="comBtn">추가</button>
				<button type="button" id="rmvBtn"	class="comBtn">삭제</button>
			</div>
		</div>
	</form>
	<!-- 조회 -->
